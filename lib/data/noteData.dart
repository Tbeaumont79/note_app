...
final noteData = [
  [
    NoteModel(
        ...
        noteDescription: 'Boost my flutter skill, by doing new app 🔥 ',
        noteDate: '16:36 PM',
        sharedWith: []),
    NoteModel(
        noteCategory: '2021',
        ...
        noteDescription: 'Go for a run every saturday 🏃‍♂️ ! ',
    ...
    NoteModel(
        ...
        noteDescription: 'Work more to get new skill ! 🚀',
  ...
  [
    ...
    NoteModel(
        ...
        noteDescription: 'What i\'ve learned so far 😀 ! ',
        noteDate: 'January 2, 2021',
        sharedWith: []),
    NoteModel(
        noteCategory: 'Flutter',
        ...
        noteDescription: 'What are the news of flutter ! Check this 🚀',
        noteDate: 'February 3, 2021',
        sharedWith: []),
  ],
  [
    NoteModel(
        ...
        noteDescription:
            'Use a Pomodoro timer, to stay focus for a longer time period ! 🕰',
        noteDate: '22:36 PM',
        sharedWith: []),
  ],
  [
    NoteModel(
        ...
        month: 'March',
        noteTitle: 'Flutter !',
        noteDescription: 'Being better in 😀 ! ',
    ...
    NoteModel(
        ...
        noteDescription: 'Help as much as i can the flutter community 🚀',
        noteDate: 'February 3, 2021',
        sharedWith: []),
    NoteModel(
        noteCategory: 'Goals',
  ...
  [
    NoteModel(
        ...
        month: 'March',
        noteTitle: 'Running !',
        noteDescription: 'Being able to run 10 km in 50 minutes 🏃‍♂️ ! ',
        noteDate: 'March 2, 2021',
        sharedWith: []),
    NoteModel(
        noteCategory: 'Goals',
